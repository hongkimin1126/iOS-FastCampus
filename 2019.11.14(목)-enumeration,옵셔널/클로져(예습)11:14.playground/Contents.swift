...
//MARK: - 정의
//{ (<#매개변수 목록#>) -> <#반환타입#> in.  //in 이라는 키워드로 코드를 분리한다.
//    <#실행 코드#>
//}
...
//********8 축약하지 않은 클로저 문법과 축약 후의 문법 비교**********
result = calculate(a: 10, b: 10, method: { (left: Int, right: Int) -> Int in
    return left + right                         //축약전***********
})

result = calculate(a: 10, b: 10) { $0 + $1 }    //축약**********
