...
//print(inside)//inside가 func 안에 있어서 밖으로 못가져 온다.
...
someFunction(argumentLabel: 10)             //아규먼트 레이블
...
func arithmeticAverage(_ numbers: Double...) -> Double      //...은 여러개 넣겠다
{
  var total = 0.0
  type(of: numbers)         //여래개 넣으면 배열 형태로 받는다.
